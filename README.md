...
Database and analytics adapters: relational engines, NoSQL engines, cloud warehouses, search, and BI dataset push.
...
| **Install name** | `linkiir-data-adapters` |
...
| **linkiir-data-adapters** _(this one)_ | relational and NoSQL databases, warehouses, BI |
